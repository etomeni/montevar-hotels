...
To delete a folder forcefully including everything in it
```
...
To copy a file to path/folder/directory
```
sudo cp awsSmmBackendFiles.zip /home/ubuntu/socialaudience/frontend/assets
```
